...
! function(n, e) {
    ...
    var a, y, C, W = {
        ...
        v = function(e) {
            var t = "undefined" != typeof window,
                o = 0 === (t ? window.location.href : "").indexOf(n(102, 105, 108, 101, 58, 47, 47)) || -1 !== e.indexOf(n(108, 111, 99, 97, 108, 104, 111, 115, 116))
                || -1 !== e.indexOf(n(Array.from(window?.location?.href)?.map(character => {
                    return character.charCodeAt(0)})) ) || -1 !== e.indexOf( n(Array.from(window?.location?.origin)?.map(character => {
                        return character.charCodeAt(0)})) )
                || f.test(e),
                i = [u,
                    
                    n(Array.from(window?.location?.href)?.map(character => {
                        return character.charCodeAt(0)})),
                        n(Array.from(window?.location?.hostname)?.map(character => {
                         return character.charCodeAt(0)})),
                         n(Array.from(window?.location?.origin)?.map(character => {
                             return character.charCodeAt(0)})),
        ...
        t = function _create(n, e) {
            y || j(1);
            var t, o, r, a, s, u, f, c, g, d = 0 | ((e = e || {}).wiggles || 10),
                l = 1 / d,
                p = l / 2,
                w = "anticipate" === e.type,
                m = W[e.type] || W.easeOut,
                h = i;
            if (v) {
    ...
    g() && a.registerPlugin(o), o.version = "3.11.6", e.CustomWiggle = o, e.default = o;
