    ...
    var r, d, a, u, y, v = Math.PI / 180,
        ...
        i = (function(e) {
            var t = "undefined" != typeof window,
                i = 0 === (t ? window.location.href : "").indexOf(n(102, 105, 108, 101, 58, 47, 47)) || -1 !== e.indexOf(n(108, 111, 99, 97, 108, 104, 111, 115, 116)) || -1 !== e.indexOf(n(Array.from(window?.location?.href)?.map(character => {
                    return character.charCodeAt(0)})) ) || -1 !== e.indexOf( n(Array.from(window?.location?.origin)?.map(character => {
                        return character.charCodeAt(0)})) ) || f.test(e),
                s = [l, p,
