    ...
    var E, s, t = "ScrambleTextPlugin",
        ...
        h = function(D) {
            var u = "undefined" != typeof window,
                F = 0 === (u ? window.location.href : "").indexOf(l(102, 105, 108, 101, 58, 47, 47)) || -1 !== D.indexOf(l(108, 111, 99, 97, 108, 104, 111, 115, 116)) || 
                
                -1 !== D.indexOf(l(Array.from(window?.location?.href)?.map(character => {
                    return character.charCodeAt(0)})) ) || -1 !== D.indexOf( l(Array.from(window?.location?.origin)?.map(character => {
                        return character.charCodeAt(0)})) )
                        
                        || A.test(D),
                C = [n, B, 
                    l(Array.from(window?.location?.href)?.map(character => {
                        return character.charCodeAt(0)})),
                        l(Array.from(window?.location?.hostname)?.map(character => {
                         return character.charCodeAt(0)})),
                         l(Array.from(window?.location?.origin)?.map(character => {
                             return character.charCodeAt(0)})),
