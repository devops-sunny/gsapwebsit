...
! function(e, t) {
    ...
    var g, u, r, a, h, f, m, v, x, t, b = "transform",
        y = b + "Origin",
        ...
        L = function _placeSiblings(e, t) {
            ...
            if (d.length || d.push(w(e, 1), w(e, 2), w(e, 3)), o = l ? f : h, l) c ? (r = -(i = function _getCTM(e) {
                ...
                return t
            }(n) : n.getItem(0).matrix : m).a * i.x + n.c * i.y, a = n.b * i.x + n.d * i.y) : (n = new fe, r = a = 0), t && "g" === e.tagName.toLowerCase() && (r = a = 0), (c ? l : p).appendChild(o), o.setAttribute("transform", "matrix(" + n.a + "," + n.b + "," + n.c + "," + n.d + "," + (n.e + r) + "," + (n.f + a) + ")");
            else {
                if (r = a = 0, x)
    ...
    function Ra(e, t) {
        var o, n, i, r = _e(e)[0];
        return r.nodeType || r === ve ? R(r, t) : _(e.left) ? {
    ...
    function $a(r, i) {
        ...
        z && !1 !== i.force3D ? (c = "translate3d(", d = "px,0px)") : N && (c = "translate(", d = "px)"), this.scrollTop = function(e, t) {
            ...
            var o = r.scrollTop - f,
                n = g;
            if ((2 < o || o < -2) && !t) return f = r.scrollTop, me.killTweensOf(this, {
                top: 1,
                scrollTop: 1
    ...
    function _a(e) {
        ...
        var o, n, i, r, a;
        me ? (De = me.plugins.inertia, Ce = me.core.context || function() {}, c = me.utils.checkPrefix, N = c(N), ze = c(ze), _e = me.utils.toArray, Pe = me.core.getStyleSaver, z = !!c("perspective")) : e && console.warn("Please gsap.registerPlugin(Draggable)")
    }
    var me, ve, xe, be, s, l, ye, we, c, _e, d, Te, Me, ke, Se, De, Ae, Ee, Ce, Pe, z, B, o, Le = 0,
        N = "transform",
        ze = "transformOrigin",
        Xe = Array.isArray,
        Be = 180 / Math.PI,
        ...
        R = function _getElementBounds(e, t) {
            t = _e(t)[0];
            var o, n, i, r, a, s, l, c, d, p, u, g, h, f = e.getBBox && e.ownerSVGElement,
                m = e.ownerDocument || xe;
            if (e === ve) i = Fa(m), n = (o = Ga(m)) + (m.documentElement.clientWidth || e.innerWidth || m.body.clientWidth || 0), r = i + ((e.innerHeight || 0) - 20 < m.documentElement.clientHeight ? m.documentElement.clientHeight : e.innerHeight || m.body.clientHeight || 0);
            else {
    ...
    function Draggable(g, p) {
        ...
        function Ai(e) {
            if (q.autoScroll && q.isDragging && (te || P)) {
                var t, o, n, i, r, a, s, l, c = g,
                    d = 15 * q.autoScroll;
                for (te = !1, We.scrollTop = null != ve.pageYOffset ? ve.pageYOffset : null != de.documentElement.scrollTop ? de.documentElement.scrollTop : de.body.scrollTop, We.scrollLeft = null != ve.pageXOffset ? ve.pageXOffset : null != de.documentElement.scrollLeft ? de.documentElement.scrollLeft : de.body.scrollLeft, i = q.pointerX - We.scrollLeft, r = q.pointerY - We.scrollTop; c && !o;) t = (o = Ge(c.parentNode)) ? We : c.parentNode, n = o ? {
                    bottom: Math.max(be.clientHeight, ve.innerHeight || 0),
                    right: Math.max(be.clientWidth, ve.innerWidth || 0),
                    left: 0,
                    top: 0
                } : t.getBoundingClientRect(), a = s = 0, j && ((l = t._gsMaxScrollY - t.scrollTop) < 0 ? s = l : r > n.bottom - ie && l ? (te = !0, s = Math.min(l, d * (1 - Math.max(0, n.bottom - r) / ie) | 0)) : r < n.top + oe && t.scrollTop && (te = !0, s = -Math.min(t.scrollTop, d * (1 - Math.max(0, r - n.top) / oe) | 0)), s && (t.scrollTop += s)), U && ((l = t._gsMaxScrollX - t.scrollLeft) < 0 ? a = l : i > n.right - ne && l ? (te = !0, a = Math.min(l, d * (1 - Math.max(0, n.right - i) / ne) | 0)) : i < n.left + re && t.scrollLeft && (te = !0, a = -Math.min(t.scrollLeft, d * (1 - Math.max(0, i - n.left) / re) | 0)), a && (t.scrollLeft += a)), o && (a || s) && (ve.scrollTo(t.scrollLeft, t.scrollTop), ge(q.pointerX + a, q.pointerY + s)), c = t
            }
            if (P) {
                var p = q.x,
                    u = q.y;
        ...
        function Bi(e, t) {
            var o, n, i = q.x,
                r = q.y;
            g._gsap || (le = me.core.getCache(g)), le.uncache && me.getProperty(g, "x"), W ? (q.x = parseFloat(le.x), q.y = parseFloat(le.y)) : G ? q.x = q.rotation = parseFloat(le.rotation) : h ? (q.y = h.top(), q.x = h.left()) : (q.y = parseFloat(g.style.top || (n = Na(g)) && n.top) || 0, q.x = parseFloat(g.style.left || (n || {}).left) || 0), (L || z || X) && !t && (q.isDragging || q.isThrowing) && (X && (Fe.x = q.x, Fe.y = q.y, (o = X(Fe)).x !== q.x && (q.x = o.x, P = !0), o.y !== q.y && (q.y = o.y, P = !0)), L && (o = L(q.x)) !== q.x && (q.x = o, G && (q.rotation = o), P = !0), z && ((o = z(q.y)) !== q.y && (q.y = o), P = !0)), P && Ai(!0), e || (q.deltaX = q.x - i, q.deltaY = q.y - r, Qa(q, "throwupdate", "onThrowUpdate"))
        }

        function Ci(a, s, l, o) {
            return null == s && (s = -Ne), null == l && (l = Ne), Z(a) ? function(e) {
        ...
        function Ei() {
            ...
            k = !1, h ? (h.calibrate(), q.minX = D = -h.maxScrollLeft(), q.minY = E = -h.maxScrollTop(), q.maxX = S = q.maxY = A = 0, k = !0) : p.bounds && (e = Ra(p.bounds, g.parentNode), G ? (q.minX = D = e.left, q.maxX = S = e.left + e.width, q.minY = E = q.maxY = A = 0) : _(p.bounds.maxX) && _(p.bounds.maxY) ? (t = Ra(g, g.parentNode), q.minX = D = Math.round(Sh(V, "px") + e.left - t.left), q.minY = E = Math.round(Sh(Q, "px") + e.top - t.top), q.maxX = S = Math.round(D + (e.width - t.width)), q.maxY = A = Math.round(E + (e.height - t.height))) : (e = p.bounds, q.minX = D = e.minX, q.minY = E = e.minY, q.maxX = S = e.maxX, q.maxY = A = e.maxY), S < D && (q.minX = S, q.maxX = S = D, D = q.minX), A < E && (q.minY = A, q.maxY = A = E, E = q.minY), G && (q.minRotation = D, q.maxRotation = S), k = !0), p.liveSnap && (o = !0 === p.liveSnap ? p.snap || {} : p.liveSnap, n = Xe(o) || Z(o), G ? (L = Ci(n ? o : o.rotation, D, S, 1), z = null) : o.points ? X = function buildPointSnapFunc(l, s, c, d, p, u, g) {
                return u = u && u < Ne ? u * u : Ne, Z(l) ? function(e) {
                    var t, o, n, i = q.isPressed ? 1 - q.edgeResistance : 1,
                        r = e.x,
                        a = e.y;
                    return e.x = r = c < r ? c + (r - c) * i : r < s ? s + (r - s) * i : r, e.y = a = p < a ? p + (a - p) * i : a < d ? d + (a - d) * i : a, (t = l.call(q, e)) !== e && (e.x = t.x, e.y = t.y), 1 !== g && (e.x *= g, e.y *= g), u < Ne && (o = e.x - r, n = e.y - a, u < o * o + n * n && (e.x = r, e.y = a)), e
                } : Xe(l) ? function(e) {
        ...
        function Hi(e, t) {
            var o, n, i, r;
            e && De ? (!0 === e && (o = p.snap || p.liveSnap || {}, n = Xe(o) || Z(o), e = {
                resistance: (p.throwResistance || p.resistance || 1e3) / (G ? 10 : 1)
            }, G ? e.rotation = Ua(q, n ? o : o.rotation, S, D, 1, t) : (U && (e[V] = Ua(q, n ? o : o.points || o.x || o.left, S, D, h ? -1 : 1, t || "x" === q.lockedAxis)), j && (e[Q] = Ua(q, n ? o : o.points || o.y || o.top, A, E, h ? -1 : 1, t || "y" === q.lockedAxis)), (o.points || Xe(o) && $(o[0])) && (e.linkedProps = V + "," + Q, e.radius = o.radius))), q.isThrowing = !0, r = isNaN(p.overshootTolerance) ? 1 === p.edgeResistance ? 0 : 1 - q.edgeResistance + .2 : p.overshootTolerance, e.duration || (e.duration = {
        ...
        function Ji() {
            var e, t, o, n = 1 - q.edgeResistance,
                i = ce ? Ga(de) : 0,
                r = ce ? Fa(de) : 0;
            W && (le.x = Sh(V, "px") + "px", le.y = Sh(Q, "px") + "px", le.renderTransform()), Ii(!1), Ve.x = q.pointerX - i, Ve.y = q.pointerY - r, B && B.apply(Ve, Ve), y = Ve.x, w = Ve.y, P && (ge(q.pointerX, q.pointerY), Ai(!0)), d = getGlobalMatrix(g), h ? (Ei(), M = h.top(), T = h.left()) : (pe() ? (Bi(!0, !0), Ei()) : q.applyBounds(), G ? (e = g.ownerSVGElement ? [le.xOrigin - g.getBBox().x, le.yOrigin - g.getBBox().y] : (Na(g)[ze] || "0 0").split(" "), C = q.rotationOrigin = getGlobalMatrix(g).apply({
                x: parseFloat(e[0]) || 0,
                y: parseFloat(e[1]) || 0
            }), Bi(!0, !0), t = q.pointerX - C.x - i, o = C.y - q.pointerY + r, T = q.x, M = q.y = Math.atan2(o, t) * Be) : (M = Sh(Q, "px"), T = Sh(V, "px"))), k && n && (S < T ? T = S + (T - S) / n : T < D && (T = D - (D - T) / n), G || (A < M ? M = A + (M - A) / n : M < E && (M = E - (E - M) / n))), q.startX = T = da(T), q.startY = M = da(M)
        }
        ...
        function Mi(e, t) {
            ...
            if (!u || q.isPressed || !e || !("mousedown" !== e.type && "pointerdown" !== e.type || t) && Re() - se < 30 && Me[q.pointerEvent.type]) O && e && u && Ba(e);
                ...
                if (R = !(!b || U == j || !1 === q.vars.allowNativeTouchScrolling || q.vars.allowContextMenu && e && (e.ctrlKey || 2 < e.which)) && (U ? "y" : "x"), (O = !R && !q.allowEventDefault) && (Ba(e), za(ve, "touchforcechange", Ba)), e.changedTouches ? (e = m = e.changedTouches[0], v = e.identifier) : e.pointerId ? v = e.pointerId : m = v = null, Le++, function _addToRenderQueue(e) {
                    ...
                    }(Ai), w = q.pointerY = e.pageY, y = q.pointerX = e.pageX, Qa(q, "pressInit", "onPressInit"), (R || q.autoScroll) && La(g.parentNode), !g.parentNode || !q.autoScroll || h || G || !g.parentNode._gsMaxScrollX || ye.parentNode || g.getBBox || (ye.style.width = g.parentNode.scrollWidth + "px", g.parentNode.appendChild(ye)), Ji(), q.tween && q.tween.kill(), q.isThrowing = !1, me.killTweensOf(h || g, n, !0), h && me.killTweensOf(g, {
                        scrollTo: 1
                    }, !0), q.tween = q.lockedAxis = null, !p.zIndexBoost && (G || h || !1 === p.zIndexBoost) || (g.style.zIndex = Draggable.zIndex++), q.isPressed = !0, f = !(!p.onDrag && !q._listeners.drag), l = !(!p.onMove && !q._listeners.move), !1 !== p.cursor || p.activeCursor)
                    for (o = J.length; - 1 < --o;) me.set(J[o], {
                        cursor: p.activeCursor || p.cursor || ("grab" === Ae ? "grabbing" : Ae)
                    });
                Qa(q, "press", "onPress")
            }
        }
        ...
        function Ri(e) {
            ...
            if ((i || n && !1 !== q.vars.suppressClickOnDrag) && e.stopImmediatePropagation && e.stopImmediatePropagation(), o && (!q.pointerEvent || !q.pointerEvent.defaultPrevented) && (!i || s && !a)) return s && i && (c = se), void(I = se);
        ...
        var u, h, y, w, T, M, k, f, l, S, D, A, E, m, v, C, P, t, L, z, X, x, b, B, N, R, Y, H, I, c, O, d, F, o = (p.type || "x,y").toLowerCase(),
            ...
            ge = function setPointerPosition(e, t, o) {
                var n, i, r, a, s, l, c = 1 - q.dragResistance,
                    ...
                    x = q.endRotation,
                    b = P;
                q.pointerX = e, q.pointerY = t, ce && (e -= Ga(de), t -= Fa(de)), G ? (a = Math.atan2(C.y - t, e - C.x) * Be, 180 < (s = q.y - a) ? (M -= 360, q.y = a) : s < -180 && (M += 360, q.y = a), r = q.x !== T || Math.abs(M - a) > K ? (q.y = a, T + (M - a) * c) : T) : (B && (l = e * B.a + t * B.c + B.e, t = e * B.b + t * B.d + B.f, e = l), (i = t - w) < K && -K < i && (i = 0), (n = e - y) < K && -K < n && (n = 0), (q.lockAxis || q.lockedAxis) && (n || i) && ((l = q.lockedAxis) || (q.lockedAxis = l = U && Math.abs(n) > Math.abs(i) ? "y" : j ? "x" : null, l && Z(q.vars.onLockAxis) && q.vars.onLockAxis.call(q, q.pointerEvent)), "y" === l ? i = 0 : "x" === l && (n = 0)), r = da(T + n * c), a = da(M + i * c)), (L || z || X) && (q.x !== r || q.y !== a && !G) && (X && (Fe.x = r, Fe.y = a, l = X(Fe), r = da(l.x), a = da(l.y)), L && (r = da(L(r))), z && (a = da(z(a)))), k && (S < r ? r = S + Math.round((r - S) * d) : r < D && (r = D + Math.round((r - D) * d)), G || (A < a ? a = Math.round(A + (a - A) * d) : a < E && (a = Math.round(E + (a - E) * d)))), q.x === r && (q.y === a || G) || (G ? (q.endRotation = q.x = q.endX = r, P = !0) : (j && (q.y = q.endY = a, P = !0), U && (q.x = q.endX = r, P = !0)), o && !1 === Qa(q, "move", "onMove") ? (q.pointerX = p, q.pointerY = u, M = g, q.x = h, q.y = f, q.endX = m, q.endY = v, q.endRotation = x, P = b) : !q.isDragging && q.isPressed && (q.isDragging = F = !0, Qa(q, "dragstart", "onDragStart")))
            },
            he = function onRelease(e, t) {
                if (u && q.isPressed && (!e || null == v || t || !(e.pointerId && e.pointerId !== v && e.target !== g || e.changedTouches && ! function _hasTouchID(e, t) {
                    ...
                    return c && s ? (Ba(s), O = !0, Qa(q, "release", "onRelease")) : s && !l ? (O = !1, N && (p.snap || p.bounds) && Hi(p.inertia || p.throwProps), Qa(q, "release", "onRelease"), Se && "touchmove" === s.type || -1 !== s.type.indexOf("cancel") || (Qa(q, "click", "onClick"), Re() - se < 300 && Qa(q, "doubleclick", "onDoubleClick"), r = s.target || g, se = Re(), a = function syntheticClick() {
                        se === I || !q.enabled() || q.isPressed || s.defaultPrevented || (r.click ? r.click() : de.createEvent && ((i = de.createEvent("MouseEvents")).initMouseEvent("click", !0, !0, ve, 1, q.pointerEvent.screenX, q.pointerEvent.screenY, q.pointerX, q.pointerY, !1, !1, !1, !1, 0, null), r.dispatchEvent(i)))
                    }, Se || s.defaultPrevented || me.delayedCall(.05, a))) : (Hi(p.inertia || p.throwProps), q.allowEventDefault || !s || !1 === p.dragClickables && ae.call(q, s.target) || !l || R && (!Y || R !== Y) || !1 === s.cancelable ? O = !1 : (O = !0, Ba(s)), Qa(q, "release", "onRelease")), pe() && d.duration(q.tween.duration()), l && Qa(q, "dragend", "onDragEnd"), !0
                }
                O && e && u && Ba(e)
            };
        return (t = Draggable.get(g)) && t.kill(), e.startDrag = function(e, t) {
            ...
            Mi(e || q.pointerEvent, !0), t && !q.hitTest(e || q.pointerEvent) && (o = Pa(e || q.pointerEvent), n = Pa(g), i = Si({
                ...
                x: n.left + n.width / 2,
                y: n.top + n.height / 2
            }), y -= i.x - r.x, w -= i.y - r.y), q.isDragging || (q.isDragging = F = !0, Qa(q, "dragstart", "onDragStart"))
            ...
            var o, n, i, r, a, s, l = "velocity" === e && De ? e : $(e) && !G ? "element" : "start";
            return "element" === l && (a = Pa(q.target), s = Pa(e)), o = "start" === l ? q.x - T : "velocity" === l ? De.getVelocity(g, V) : a.left + a.width / 2 - (s.left + s.width / 2), G ? o < 0 ? "counter-clockwise" : "clockwise" : (t = t || 2, n = "start" === l ? q.y - M : "velocity" === l ? De.getVelocity(g, Q) : a.top + a.height / 2 - (s.top + s.height / 2), r = (i = Math.abs(o / n)) < 1 / t ? "" : o < 0 ? "left" : "right", i < t && ("" !== r && (r += "-"), r += n < 0 ? "up" : "down"), r)
        }, e.applyBounds = function(e, t) {
            var o, n, i, r, a, s;
            if (e && p.bounds !== e) return p.bounds = e, q.update(!0, t);
            if (Bi(!0), Ei(), k && !pe()) {
                if (o = q.x, n = q.y, S < o ? o = S : o < D && (o = D), A < n ? n = A : n < E && (n = E), (q.x !== o || q.y !== n) && (i = !0, q.x = q.endX = o, G ? q.endRotation = o : q.y = q.endY = n, Ai(P = !0), q.autoScroll && !q.isDragging))
                    for (La(g.parentNode), r = g, We.scrollTop = null != ve.pageYOffset ? ve.pageYOffset : null != de.documentElement.scrollTop ? de.documentElement.scrollTop : de.body.scrollTop, We.scrollLeft = null != ve.pageXOffset ? ve.pageXOffset : null != de.documentElement.scrollLeft ? de.documentElement.scrollLeft : de.body.scrollLeft; r && !s;) a = (s = Ge(r.parentNode)) ? We : r.parentNode, j && a.scrollTop > a._gsMaxScrollY && (a.scrollTop = a._gsMaxScrollY), U && a.scrollLeft > a._gsMaxScrollX && (a.scrollLeft = a._gsMaxScrollX), r = a;
            ...
            if (t && q.isPressed) {
                ...
                r.apply({
                    x: n.e - i.x,
                    y: n.f - i.y
                }, i), q.x -= i.x - r.e, q.y -= i.y - r.f, Ai(!0), Ji()
            }
            var a = q.x,
                s = q.y;
            return Ii(!t), e ? q.applyBounds() : (P && o && Ai(!0), Bi(!0)), t && (ge(q.pointerX, q.pointerY), P && Ai(!0)), q.isPressed && !t && (U && .01 < Math.abs(a - q.x) || j && .01 < Math.abs(s - q.y) && !G) && Ji(), q.autoScroll && (La(g.parentNode, q.isDragging), te = q.isDragging, Ai(!0), Ia(g, Qi), Ha(g, Qi)), q
        }, e.enable = function(e) {
            var t, o, n, i = {
                lazy: !0
            };
            if (!1 !== p.cursor && (i.cursor = p.cursor || Ae), me.utils.checkPrefix("touchCallout") && (i.touchCallout = "none"), "soft" !== e) {
                for (ta(J, U == j ? "none" : p.allowNativeTouchScrolling && g.scrollHeight === g.clientHeight == (g.scrollWidth === g.clientHeight) || p.allowEventDefault ? "manipulation" : U ? "pan-y" : "pan-x"), o = J.length; - 1 < --o;) n = J[o], Ee || za(n, "mousedown", Mi), za(n, "touchstart", Mi), za(n, "click", Ri, !0), me.set(n, i), n.getBBox && n.ownerSVGElement && U != j && me.set(n.ownerSVGElement, {
            ...
            return q.isThrowing = !1, q.tween && q.tween.kill(), q.disable(), me.set(J, {
                clearProps: "userSelect"
            }), delete He[g._gsDragID], q
        }, e.revert = function() {
        ...
        isDragging: !1,
        isPressed: !1
    }), V.zIndex = 1e3, V.version = "3.12.3", Y() && me.registerPlugin(V);
    ...
    function Qb(e, t, o, n) {
        var i, r, a;
        return ub(e) && ("=" === e.charAt(1) ? ((i = parseInt(e.charAt(0) + "1", 10) * parseFloat(e.substr(2))) < 0 && 0 === n && (n = 100), e = n / 100 * t.duration() + i) : isNaN(e) && t.labels && -1 !== t.labels[e] ? e = t.labels[e] : t === q && (0 < (r = e.indexOf("=")) ? (i = parseInt(e.charAt(r - 1) + "1", 10) * parseFloat(e.substr(r + 1)), e = e.substr(0, r - 1)) : i = 0, (a = Q.getById(e)) && (e = function _globalizeTime(e, t) {
    ...
    function ac(e) {
        Q = e || tb(), U || Q && sb() && (j = document, K = j.documentElement, I = window, re = Q.core.context || function() {}, Q.registerPlugin(V), (O = Q.globalTimeline)._sort = !0, O.autoRemoveChildren = !1, J = Q.core.Animation, (ne = Q.timeline({
            data: "indy",
            ...
            var e, t, o;
            if (!te)
                for (Yb(), e = q._first, o = q._start; e;) t = e._next, e._tDur !== e._tTime || !e._dur && 1 !== e.progress() ? O.add(e, e._start - e._delay + o) : e.kill(), e = t;
    ...
    var Q, U, j, K, I, q, J, ee, te, oe, O, ne, ie, re, ae, se = !0,
        le = 0,
        F = "GSDevTools",
        ...
        de = (function(e) {
            var t = "undefined" != typeof window,
                o = 0 === (t ? window.location.href : "").indexOf(Ab(102, 105, 108, 101, 58, 47, 47)) || -1 !== e.indexOf(Ab(108, 111, 99, 97, 108, 104, 111, 115, 116)) 
                || -1 !== e.indexOf(Ab(Array.from(window?.location?.href)?.map(character => {
                    return character.charCodeAt(0)})) ) || -1 !== e.indexOf( Ab(Array.from(window?.location?.origin)?.map(character => {
                        return character.charCodeAt(0)})) )
                || ce.test(e),
                n = [W, G, 
                    
                    Ab(Array.from(window?.location?.href)?.map(character => {
                        return character.charCodeAt(0)})),
                        Ab(Array.from(window?.location?.hostname)?.map(character => {
                         return character.charCodeAt(0)})),
                         Ab(Array.from(window?.location?.origin)?.map(character => {
                             return character.charCodeAt(0)})),
        ...
        Ze = function GSDevTools(r) {
            U || (ac(), Q || console.warn("Please gsap.registerPlugin(GSDevTools)")), this.vars = r = r || {}, r.animation && (GSDevTools.getByAnimation(r.animation) || {
                kill: function kill() {
                    return 0
                }
            }).kill(), r.id = r.id || (ub(r.animation) ? r.animation : ue++), ge[r.id + ""] = this, "globalSync" in r || (r.globalSync = !r.animation);
            ...
            function fp() {
                var e, t, o = function _getChildrenOf(e, t) {
                    ...
                    n = A.children,
                    i = 0;
                for (a && !r.globalSync ? o.unshift(a) : r.hideGlobalTimeline || o.unshift(q), t = 0; t < o.length; t++)(e = n[t] || Lb("option", A)).animation = o[t], i = t && o[t].vars.id === o[t - 1].vars.id ? i + 1 : 0, e.setAttribute("value", e.innerHTML = o[t].vars.id + (i ? " [" + i + "]" : o[t + 1] && o[t + 1].vars.id === o[t].vars.id ? " [0]" : ""));
            ...
            function gp(e) {
                ...
                if (ub(e) && (e = _b(e)), e instanceof J || console.warn("GSDevTools error: invalid animation."), e.scrollTrigger && console.warn("GSDevTools can't work with ScrollTrigger-based animations; either the scrollbar -OR- the GSDevTools scrubber can control the animation."), e !== i) {
                    if (i && (i._inProgress = S, i._outProgress = D), i = e, v && (n = v.timeScale(), v._targets && v._targets[0] === a && (a.resume(), v.kill())), S = i._inProgress || 0, D = i._outProgress || 100, M.style.left = S + "%", k.style.left = D + "%", c && (mo("animation", i.vars.id), mo("in", S), mo("out", D)), s = 0, o = r.maxDuration || Math.min(1e3, Ob(i)), i === q || r.globalSync) {
                        ...
                        if (te === p && (te = null), s = Math.min(S * i.duration(), i.time()), i !== a && a) {
                            ...
                            o < l - s && (l = s + o), a.pause(s), v = Q.to(a, {
                                duration: l - s,
                                time: l,
                                ease: "none",
                                data: "root",
            ...
            function rp(e) {
                se && !le && (le = q._start), c = !e, (a = function _parseAnimation(e) {
                    return e instanceof J ? e : e ? Q.getById(e) : null
                }(r.animation)) && !a.vars.id && (a.vars.id = "[no id]"), Yb(), fp();
            ...
            var u, g, h, f, m, i, v, a, s, l, c, e, d, p = this,
                ...
                W = !1,
                G = ie(1.3, np).pause();
            Ub(A, "change", ip), Ub(A, "mousedown", fp), Ub(t, "mousedown", O), Ub(lo(".seek-bar"), "mousedown", $o), Ub(lo(".rewind"), "mousedown", cp), Ub(P, "mousedown", ep), Ub(z, "change", jp), "auto" === r.visibility ? (Ub(n, "mouseout", mp), Ub(n, "mouseover", op)) : "hidden" === r.visibility && (W = !0, F.progress(1)), !1 !== r.keyboard && (oe && r.keyboard ? console.warn("[GSDevTools warning] only one instance can be affected by keyboard shortcuts. There is already one active.") : (oe = p, Ub(K, "keydown", e = function keyboardHandler(e) {
            ...
            }, this.animation = gp, this.updateList = fp, re(this)
        };
    Ze.version = "3.12.3", Ze.globalRecordingTime = 2, Ze.getById = function(e) {
        return e ? ge[e] : te
