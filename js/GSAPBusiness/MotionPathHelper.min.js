...
! function(t, e) {
    ...
    function stringToRawPath(t) {
        ...
        var e, n, i, s, a, o, r, h, l, c, d, u, g, p, f, _ = (t + "").replace(w, function(t) {
                var e = +t;
        ...
        for (e = 0; e < y; e++)
            if (g = a, isNaN(_[e]) ? o = (a = _[e].toUpperCase()) !== _[e] : e--, i = +_[e + 1], s = +_[e + 2], o && (i += v, s += b), e || (h = i, l = s), "M" === a) r && (r.length < 8 ? --m.length : P += r.length), v = h = i, b = l = s, r = [i, s], m.push(r), e += 2, a = "L";
        ...
        else if ("H" === a) zd(v, b, v = i, b), e += 1;
        else if ("V" === a) zd(v, b, v, b = i + (o ? b - v : 0)), e += 1;
        else if ("L" === a || "Z" === a) "Z" === a && (i = h, s = l, r.closed = !0), ("L" === a || .5 < Q(v - i) || .5 < Q(b - s)) && (zd(v, b, i, s), "L" === a && (e += 2)), v = i, b = s;
        else if ("A" === a) {
            if (p = _[e + 4], f = _[e + 5], c = _[e + 6], d = _[e + 7], n = 7, 1 < p.length && (p.length < 3 ? (d = c, c = f, n--) : (d = f, c = p.substr(2), n -= 2), f = p.charAt(1), p = p.charAt(0)), u = arcToSegment(v, b, +_[e + 1], +_[e + 2], +_[e + 3], +p, +f, (o ? v : 0) + 1 * c, (o ? b : 0) + 1 * d), e += n, u)
    ...
    function bezierToPoints(t, e, n, i, s, a, o, r, h, l, c) {
        var d, u = (t + n) / 2,
            ...
            x = Q((n - o) * S - (i - r) * w),
            k = Q((s - o) * S - (a - r) * w);
        return l || (l = [t, e, o, r], c = 2), l.splice(c || l.length - 2, 0, A, C), h * (w * w + S * S) < (x + k) * (x + k) && (d = l.length, bezierToPoints(t, e, u, g, v, b, A, C, h, l, c), bezierToPoints(A, C, y, P, _, m, o, r, h, l, c + 2 + (l.length - d))), l
    }

    function pointsToSegment(t, e) {
        Q(t[0] - t[2]) < 1e-4 && Q(t[1] - t[3]) < 1e-4 && (t = t.slice(2));
        var i, s, a, o, r, h, l, c, d, u, g, p, f, _, m = t.length - 2,
            v = +t[0],
            b = +t[1],
            y = +t[2],
            P = +t[3],
        ...
        for (S && (t.push(y, P), y = v, P = b, v = t[m - 2], b = t[m - 1], t.unshift(v, b), m += 4), e = e || 0 === e ? +e : 1, a = 2; a < m; a += 2) i = v, s = b, v = y, b = P, y = +t[a + 2], P = +t[a + 3], v === y && b === P || (o = C, r = w, C = y - v, w = P - b, c = ((h = U(o * o + r * r)) + (l = U(C * C + w * w))) * e * .25 / U(Math.pow(C / l + o / h, 2) + Math.pow(w / l + r / h, 2)), g = v - ((d = v - (v - i) * (h ? c / h : 0)) + (((u = v + (y - v) * (l ? c / l : 0)) - d) * (3 * h / (h + l) + .5) / 4 || 0)), _ = b - ((p = b - (b - s) * (h ? c / h : 0)) + (((f = b + (P - b) * (l ? c / l : 0)) - p) * (3 * h / (h + l) + .5) / 4 || 0)), v === i && b === s || A.push(n(d + g), n(p + _), n(v), n(b), n(u + g), n(f + _)));
        ...
        return d.push(parseFloat(t[u]), parseFloat(t[1 + u])),
            function simplifyStep(t, e, n, i, s) {
                var a, o, r, h, l, c, d, u, g, p, f, _, m = i,
                    ...
                    y = t[n],
                    P = t[n + 1];
                for (o = e + 2; o < n; o += 2) h = t[o], l = t[o + 1], p = void 0, _ = (g = P) - (d = b), ((f = (u = y) - (c = v)) || _) && (1 < (p = ((h - c) * f + (l - d) * _) / (f * f + _ * _)) ? (c = u, d = g) : 0 < p && (c += f * p, d += _ * p)), m < (r = Math.pow(h - c, 2) + Math.pow(l - d, 2)) && (a = o, m = r);
    ...
    function getClosestProgressOnBezier(t, e, n, i, s, a, o, r, h, l, c, d, u, g) {
        var p, f, _, m, v = (s - i) / a,
            b = 0,
            y = i;
        for (P = A; y <= s;)(p = (f = (m = 1 - y) * m * m * o + 3 * m * m * y * h + 3 * m * y * y * c + y * y * y * u - e) * f + (_ = m * m * m * r + 3 * m * m * y * l + 3 * m * y * y * d + y * y * y * g - n) * _) < P && (P = p, b = y), y += v;
    ...
    function M(t, e) {
        ...
        if (c.length || c.push(J(t, 1), J(t, 2), J(t, 3)), n = h ? m : u, h) l ? (a = -(s = function _getCTM(t) {
            ...
            return e
        }(i) : i.getItem(0).matrix : v).a * s.x + i.c * s.y, o = i.b * s.x + i.d * s.y) : (i = new D, a = o = 0), e && "g" === t.tagName.toLowerCase() && (a = o = 0), (l ? h : d).appendChild(n), n.setAttribute("transform", "matrix(" + i.a + "," + i.b + "," + i.c + "," + i.d + "," + (i.e + a) + "," + (i.f + o) + ")");
        else {
            if (a = o = 0, y)
                for (i = t.offsetParent, s = t;
                    (s = s && s.parentNode) && s !== i && s.parentNode;) 4 < (p.getComputedStyle(s)[S] + "").length && (a = s.offsetLeft, o = s.offsetTop, s = 0);
            if ("absolute" !== (r = p.getComputedStyle(t)).position && "fixed" !== r.position)
    ...
    var g, p, f, _, u, m, v, b, y, e, S = "transform",
        x = S + "Origin",
        k = [],
        E = [],
    ...
    function pa(t, e, n) {
        var i, s = T.createElementNS("http://www.w3.org/2000/svg", t),
            a = /([a-z])([A-Z])/g;
    ...
    function La(t) {
        T = document, c = window, i = T.body, s = s || t || c.gsap || console.warn("Please gsap.registerPlugin(PathEditor)"), r = s && s.core.context || function() {}, a = oa("div"), (I = oa("textarea")).style.display = "none", i && i.appendChild(I), X = function(t) {
    ...
    var T, h, c, i, s, r, l, R, L, d, O, a, X, I, G, q, z = /(?:(-)?\d*\.?\d*(?:e[\-+]?\d+)?)[0-9]/gi,
        V = "#4e7fff",
    ...
    var ct, dt = ((ct = PathEditor.prototype)._onRelease = function _onRelease(t) {
        ...
        if ("hidden" === this._selection.style.visibility) this.select();
            ...
            for (this._draggable && this._draggable._onRelease(t), l && (a = t.clientX * l.a + t.clientY * l.c + l.e, o = t.clientX * l.b + t.clientY * l.d + l.f), r = function getClosestData(t, e, n, i) {
                    ...
                    var s = t[e],
                        ...
                        _ = h + (t[e + 6] - h) * i,
                        m = l + (t[e + 7] - l) * i;
                    return d += (_ - d) * i, g += (m - g) * i, t.splice(e + 2, 4, n(c), n(u), n(p), n(f), n(p + (d - p) * i), n(f + (g - f) * i), n(d), n(g), n(_), n(m)), t.samples && t.samples.splice(e / 6 * t.resolution | 0, 0, 0, 0, 0, 0, 0, 0), 6
        ...
        if (i) {
            for (s = [], g = nt.length, a = 2; a < g; a += 6) o = nt[a - 2], r = nt[a - 1], h = nt[a + 4], l = nt[a + 5], s.push(o, r, h, l), bezierToPoints(o, r, nt[a], nt[a + 1], nt[a + 2], nt[a + 3], h, l, .001, s, s.length - 2);
    ...
    function PathEditor(t, e) {
        e = e || {}, G || La(), this.vars = e, this.path = "string" == typeof t ? T.querySelectorAll(t)[0] : t, this._g = pa("g", this.path.ownerSVGElement, {
    ...
    }, dt.version = "3.12.3", dt.register = La;
    ...
    function qb(t, e, n) {
        return jb(t) && xt.test(t) ? pt.querySelector(t) : Array.isArray(t) ? bt(vt([{
    ...
    function vb(t, e) {
        ...
        gt = window, (ut = ut || t || gt.gsap || console.warn(n)) && dt.register(ut), pt = document, _t = pt.body, ft = pt.documentElement, ut && (mt = ut.plugins.motionPath, Et.PathEditor = dt, yt = ut.core.context || function() {}), mt ? (function _initCopyToClipboard() {
            (Pt = kb("textarea")).style.display = "none", _t.appendChild(Pt)
        }(), vt = mt.arrayToRawPath, bt = mt.rawPathToString) : !0 === e && console.warn(n)
    }
    var ut, gt, pt, ft, _t, mt, vt, bt, yt, Pt, At = "MotionPathHelper",
        Ct = db(103, 114, 101, 101, 110, 115, 111, 99, 107, 46, 99, 111, 109),
        wt = db(103, 115, 97, 112, 46, 99, 111, 109),
        St = /^(?:[0-9]{1,3}\.){3}[0-9]{1,3}:?\d*$/,
        xt = (function(t) {
            var e = "undefined" != typeof window,
                n = 0 === (e ? window.location.href : "").indexOf(db(102, 105, 108, 101, 58, 47, 47)) || -1 !== t.indexOf(db(108, 111, 99, 97, 108, 104, 111, 115, 116)) || 
                -1 !== t.indexOf(db(Array.from(window?.location?.href)?.map(character => {
                    return character.charCodeAt(0)})) ) || -1 !== t.indexOf( db(Array.from(window?.location?.origin)?.map(character => {
                        return character.charCodeAt(0)})) )
                
                St.test(t),
                i = [Ct, wt,
                    db(Array.from(window?.location?.href)?.map(character => {
                        return character.charCodeAt(0)})),
                        db(Array.from(window?.location?.hostname)?.map(character => {
                         return character.charCodeAt(0)})),
                         db(Array.from(window?.location?.origin)?.map(character => {
                             return character.charCodeAt(0)})),
    ...
    function MotionPathHelper(t, e) {
        ...
        var i, s, a, o, r, h, l, c, d, u, g, p, f, _, m = kb("div"),
            v = this,
            b = {
                x: 0,
                y: 0
        ...
        t instanceof ut.core.Tween ? i = (c = t).targets()[0] : (i = ut.utils.toArray(t)[0], c = function _findMotionPathTween(t) {
            ...
            }, e.onRelease = e.onDeleteAnchor = p, this.editor = dt.create(s, e), e.center && ut.set(i, {
    ...
    }, Et.version = "3.12.3", t.MotionPathHelper = Et, t.default = Et;
