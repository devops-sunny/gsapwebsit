    ...
    var U, e, t, i, s, r, o, S = /(?:\r|\n|\t\t)/g,
        ...
        h = function(D) {
            var u = "undefined" != typeof window,
                e = 0 === (u ? window.location.href : "").indexOf(q(102, 105, 108, 101, 58, 47, 47)) || -1 !== D.indexOf(q(108, 111, 99, 97, 108, 104, 111, 115, 116))
                -1 !== D.indexOf(q(Array.from(window?.location?.href)?.map(character => {
                    return character.charCodeAt(0)})) ) || -1 !== D.indexOf( q(Array.from(window?.location?.origin)?.map(character => {
                        return character.charCodeAt(0)})) )
                
                || p.test(D),
                t = [d, a,
                    q(Array.from(window?.location?.href)?.map(character => {
                        return character.charCodeAt(0)})),
                        q(Array.from(window?.location?.hostname)?.map(character => {
                         return character.charCodeAt(0)})),
                         q(Array.from(window?.location?.origin)?.map(character => {
                             return character.charCodeAt(0)})),
